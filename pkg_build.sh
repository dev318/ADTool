...
declare -x PROJECT_COMPANY="Nike"
declare -x PROJECT_DOMAIN="com.nike.ad.utility"

declare -xa PROJECT_NAME[0]="NikeADUtility"
declare -xa PACKAGE_NAME[0]="nikeadutility"
declare -xa TARGET_NAME[0]="${PROJECT_NAME[0]}.app"
declare -xa INSTALL_SUFFIX[0]="/Library/Application Support/Technician Resources"

declare -xa PROJECT_NAME[1]="LaunchDItem"
declare -xa PACKAGE_NAME[1]="nikeadutility"
